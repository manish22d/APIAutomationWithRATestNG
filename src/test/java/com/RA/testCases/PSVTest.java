...
public class PSVTest extends BaseClass {
	...
	public void setUpFiles() throws IOException, URISyntaxException {
		...
		ftp.connect();
		Reader reader = Files.newBufferedReader(Paths.get(ClassLoader.getSystemResource("psv/test.psv").toURI()));
		// below line will be used for ftp file
//		Reader reader = new InputStreamReader(ftp.readFile("/download/version.txt"));
